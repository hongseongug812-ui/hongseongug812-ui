...
<table>
<tr><td><b>관심 분야</b></td><td>풀스택 · 백엔드 · AI/LLM · Python · JavaScript · Java</td></tr><tr><td><b>자격증</b></td><td>CLF-C02 (AWS Certified Cloud Practitioner)</td></tr></table>
...
<img src="https://img.shields.io/badge/-Python-333333?style=flat-square" alt="Python">        <img src="https://img.shields.io/github/stars/hongseongug812-ui/auto-profile-curator?style=flat-square&label=%E2%98%85&color=00e01a&labelColor=333333" alt="stars">
    ...
    <td width="50%" valign="top">
      ...
      <p>이 툴은 마인크래프트 서버를 웹 기반으로 쉽게 열고 관리할 수 있게 해주는 도구입니다. 포트포워딩 없이 playit.gg를 통해 외부 접속을 지원하며, 팀원 권한 관리, 실시간 모니터링 기능을 제공합니다. 또한, 플러그인 업로드와 JVM 성능 최적화(Aikar's JVM 플러그, Lithium 등) 기능을 포함하고 있습니다.</p>
      <p>
