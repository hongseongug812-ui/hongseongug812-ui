...
<sub>공개 저장소를 자동으로 분석 · 매시간 갱신</sub>
...
<table>
<tr><td><b>관심 분야</b></td><td>풀스택 · 백엔드 · AI/LLM · Python · JavaScript · Java</td></tr></table>
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      <h3>현재 집중하는 것</h3>
      <ul><li>풀스택 프로젝트 진행 중</li><li>백엔드 프로젝트 진행 중</li></ul>
    </td>
  </tr>
</table>
...
<table>
<tr><td><b>AI & 클라우드</b></td><td><code>OpenAI</code> &nbsp;<code>LLM</code> &nbsp;<code>PyTorch</code> &nbsp;<code>Gemma</code> &nbsp;<code>AWS</code></td></tr><tr><td><b>백엔드</b></td><td><code>FastAPI</code> &nbsp;<code>Spring Boot</code> &nbsp;<code>Python</code> &nbsp;<code>Java</code> &nbsp;<code>Kotlin</code> &nbsp;<code>Node.js</code></td></tr><tr><td><b>프론트엔드</b></td><td><code>React</code> &nbsp;<code>Next.js</code> &nbsp;<code>TypeScript</code> &nbsp;<code>JavaScript</code></td></tr><tr><td><b>데이터베이스</b></td><td><code>Supabase</code> &nbsp;<code>PostgreSQL</code> &nbsp;<code>MySQL</code> &nbsp;<code>Redis</code> &nbsp;<code>SQL</code></td></tr></table>
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p><a href="https://github.com/hongseongug812-ui/mc-devkit">MC DevKit is a web-based server management tool that allows easy opening and managing of Minecraft servers without port forwarding, supporting external access, team management, real-time monitoring, and automatic performance optimization.</a></p>
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p><a href="https://github.com/hongseongug812-ui/llm-bench-dashboard">This GitHub repository provides a CLI tool for benchmarking local large language models on both macOS and Windows, generating a real-time dashboard with comparative metrics and creating an auto-generated PDF report summarizing the results.</a></p>
      <p><sub><b>Python</b> · ★ 0 · 포크 0 · 업데이트 2026-07-14</sub></p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      ...
      <p><a href="https://github.com/hongseongug812-ui/grounded_work_ai">Grounded Work AI is an AI business assistant platform that uses grounded artificial intelligence to generate answers, drafts, and execute actions based on uploaded documents. It includes features for document-based Q&A, automatic email/Jira ticket/Slack message drafting, and action approval with real-time monitoring.</a></p>
      <p><sub><b>Python</b> · ★ 0 · 포크 0 · 업데이트 2026-03-08</sub></p>
    </td>
    <td width="50%" valign="top">
      <h3><a href="https://github.com/hongseongug812-ui/safewave">safewave</a></h3>
      <p><a href="https://github.com/hongseongug812-ui/safewave">SafeWave is a real-time AI platform that detects falls, unauthorized entries, and prolonged inactivity using WiFi Channel State Information (CSI), without the need for cameras or wearable devices, and notifies caregivers via WebSocket.</a></p>
      <p><sub><b>JavaScript</b> · ★ 0 · 포크 0 · 업데이트 2026-04-04</sub></p>
    </td>
  </tr>
</table>
